...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "bg-white dark:bg-white relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full bg-white px-4 py-2 lg:flex dark:bg-white",
  ...
  return (
    ...
    >
      <Image
        ...
        height={30}
      />
      <span className="font-medium text-black dark:text-white">HireFlow</span>
    </a>
  );
};
